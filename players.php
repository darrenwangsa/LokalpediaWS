...
(REPLACE(STR(?idTeam), "^.*/", "") AS ?individualsTeam)
WHERE {{
    ?player :playerOf ?idTeam .
    }
    ?idTeam :teamName ?team
    OPTIONAL{
...
<head>
    ...
    <title>Lokalpedia - Players & Staff</title>
    ...
    <div class="main-content">
        <div class="con">
            ...
            <div class="roster-grid">
                <?php 
                $response = file_get_contents($endpoint . "?query=" . urlencode($sparqlQueryPlayers) . "&format=json");
